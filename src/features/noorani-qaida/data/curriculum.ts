...
// name = English letter name · sound = beginner pronunciation cue shown under the glyph
export const LETTERS: Letter[] = [
  [1,"ا","Alif","aa",["ا","ا","ـا","ـا"],"أَلِف","Alif","Open throat and chest"],
  [2,"ب","Ba","ba",["ب","بـ","ـبـ","ـب"],"بَيْت","House","Both lips together"],
  [3,"ت","Ta","ta",["ت","تـ","ـتـ","ـت"],"تُفَّاح","Apple","Tongue tip at upper teeth"],
  [4,"ث","Tha","tha",["ث","ثـ","ـثـ","ـث"],"ثَلْج","Snow","Tongue gently between teeth"],
  [5,"ج","Jeem","jeem",["ج","جـ","ـجـ","ـج"],"جَمَل","Camel","Middle tongue at palate"],
  [6,"ح","Haa","ḥaa",["ح","حـ","ـحـ","ـح"],"حِصَان","Horse","Middle throat"],
  [7,"خ","Kha","kha",["خ","خـ","ـخـ","ـخ"],"خُبْز","Bread","Upper throat"],
  [8,"د","Dal","dal",["د","د","ـد","ـد"],"دُجَاج","Chicken","Tongue tip at upper teeth"],
  [9,"ذ","Dhal","dhal",["ذ","ذ","ـذ","ـذ"],"ذَهَب","Gold","Tongue between teeth, voiced"],
  [10,"ر","Ra","ra",["ر","ر","ـر","ـر"],"رَأْس","Head","Tongue tip at gum ridge"],
  [11,"ز","Zain","za",["ز","ز","ـز","ـز"],"زَهْرَة","Flower","Tongue behind lower teeth"],
  [12,"س","Seen","seen",["س","سـ","ـسـ","ـس"],"سَمَاء","Sky","Light hiss behind lower teeth"],
  [13,"ش","Sheen","sheen",["ش","شـ","ـشـ","ـش"],"شَجَرَة","Tree","Wide airflow over tongue"],
  [14,"ص","Saad","ṣaad",["ص","صـ","ـصـ","ـص"],"صَبْر","Patience","Heavy emphatic S"],
  [15,"ض","Daad","ḍaad",["ض","ضـ","ـضـ","ـض"],"ضَوْء","Light","Side of tongue at molars"],
  [16,"ط","Taa","ṭaa",["ط","طـ","ـطـ","ـط"],"طَيْر","Bird","Raised back tongue"],
  [17,"ظ","Zaa","ẓaa",["ظ","ظـ","ـظـ","ـظ"],"ظَبْي","Deer","Heavy tongue between teeth"],
  [18,"ع","Ain","ʿain",["ع","عـ","ـعـ","ـع"],"عِنَب","Grapes","Middle throat"],
  [19,"غ","Ghain","ghain",["غ","غـ","ـغـ","ـغ"],"غَيْم","Cloud","Upper throat, voiced"],
  [20,"ف","Fa","fa",["ف","فـ","ـفـ","ـف"],"فِيل","Elephant","Upper teeth on lower lip"],
  [21,"ق","Qaf","qaf",["ق","قـ","ـقـ","ـق"],"قَمَر","Moon","Back tongue near uvula"],
  [22,"ك","Kaf","kaf",["ك","كـ","ـكـ","ـك"],"كِتَاب","Book","Back tongue at soft palate"],
  [23,"ل","Lam","lam",["ل","لـ","ـلـ","ـل"],"لَيْث","Lion","Tongue tip at gum ridge"],
  [24,"م","Meem","meem",["م","مـ","ـمـ","ـم"],"مَاء","Water","Both lips closed"],
  [25,"ن","Noon","noon",["ن","نـ","ـنـ","ـن"],"نَجْم","Star","Tongue tip with nasal sound"],
  [26,"ه","Ha","ha",["ه","هـ","ـهـ","ـه"],"هَوَاء","Air","Gentle chest breath"],
  [27,"و","Waw","waw",["و","و","ـو","ـو"],"وَرْدَة","Rose","Rounded lips"],
  [28,"ي","Ya","ya",["ي","يـ","ـيـ","ـي"],"يَد","Hand","Middle tongue toward palate"],
